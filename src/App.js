          ...
          <div className="landing-pic-container">
            ...
            <div className="statistic">
              <p className="statistic__text">
                {" "}
                " More than 60% of Job Seekers lose track of their
                applications"{" "}
              </p>
            </div>
          </div>
            ...
            <div className="expandable-box" onClick={() => toggleBox(2)}>
              ...
              >
                <p>
                  ...
                  resources will help you ace your next job interview. From
                  common questions to tips and tricks for acing the interview,
                  our community has everything you need to land your dream job.
                  Join now and start preparing for success.</p>{" "}
              </div>
            </div>
            <div className="expandable-box" onClick={() => toggleBox(3)}>
              ...
              >
                <p>
                  ...
                  learners will help you find the resources you need to take
            ...
            <div className="expandable-box" onClick={() => toggleBox(4)}>
              ...
              >
                <p>
                  ...
                  opportunities in your field. Sign up now to start building
                  your career and unlocking exciting job prospects.
                </p>{" "}
              </div>
            </div>
          </div>
